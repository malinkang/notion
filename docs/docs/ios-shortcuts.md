...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin: 16px 0;">
  <figure style="margin: 0;">
    <img src="/ios-shortcuts/automation-entry.svg" alt="在快捷指令 App 底部进入自动化，并点击右上角加号" style="width: 100%; border-radius: 16px;" />
    <figcaption style="font-size: 14px; color: var(--vp-c-text-2); margin-top: 8px; text-align: center;">进入「自动化」并点击 +</figcaption>
  </figure>
  <figure style="margin: 0;">
    <img src="/ios-shortcuts/select-app-trigger.svg" alt="在自动化触发条件列表中选择 App" style="width: 100%; border-radius: 16px;" />
    <figcaption style="font-size: 14px; color: var(--vp-c-text-2); margin-top: 8px; text-align: center;">选择「App」触发条件</figcaption>
  </figure>
  <figure style="margin: 0;">
    <img src="/ios-shortcuts/app-closed-immediate.svg" alt="选择 App 后勾选已关闭，并设置为立即运行" style="width: 100%; border-radius: 16px;" />
    <figcaption style="font-size: 14px; color: var(--vp-c-text-2); margin-top: 8px; text-align: center;">勾选「已关闭」和「立即运行」</figcaption>
  </figure>
</div>
...
::: tip 设置重点
如果你的 iOS 页面里显示的是「运行前询问」，请关闭它；如果显示的是「立即运行」，请选择「立即运行」。这样触发条件满足时会自动同步，不需要每次手动确认。
:::
